...
# Define the fitness function using SVM
...
plt.title("PSO-like Feature Selection Progress for SVM (Classification)")
plt.xlabel("Iteration")
plt.ylabel("Best Accuracy")
plt.grid(True)
plt.show()

print('Selected Features (SVM - Classification):', selected_features_pso)
...
clf_selected_pso = SVC(kernel='linear', C=1.0, random_state=42)
...
print('Accuracy with Selected Features (SVM - Classification):', accuracy_pso)
