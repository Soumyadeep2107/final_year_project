...
plt.title("PSO-like Feature Selection Progress for KNN (Classification)")
plt.xlabel("Iteration")
plt.ylabel("Best Accuracy")
plt.grid(True)
plt.show()

print('Selected Features (KNN - Classification):', selected_features_pso)
...
clf_selected_pso = KNeighborsClassifier(n_neighbors=5)
...
print('Accuracy with Selected Features (KNN - Classification):', accuracy_pso)
